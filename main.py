...
def insert_into_db(parsed_data):
    ...
    try:
        ...
        client.execute('INSERT INTO {0} (event_date, ip_server, url, ip_nat, ip_abon, protocol_type) VALUES'.format(table_name), parsed_data) #execute comand for inserting data
